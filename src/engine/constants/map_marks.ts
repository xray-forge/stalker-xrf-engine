...
export const mapMarks = {
  ...
  secondary_task_location: "secondary_task_location",
  secondary_task_on_guider: "secondary_task_on_guider",
  storyline_task_location: "storyline_task_location",
  storyline_task_on_guider: "storyline_task_on_guider",
  treasure: "treasure",
  treasure_epic: "treasure_epic",
  treasure_rare: "treasure_rare",
  treasure_unique: "treasure_unique",
  ui_pda2_actor_box_location: "ui_pda2_actor_box_location",
  ...
  ui_secondary_task_blink: "ui_secondary_task_blink",
  ui_storyline_task_blink: "ui_storyline_task_blink",
} as const;
