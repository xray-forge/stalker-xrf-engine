...
import { parseConditionsList, parseNames, parseParameters, TConditionList } from "@/engine/scripts/utils/parse";
...
export function getConfigObjectAndZone(
  ...
  const { getStoryObjectId } = require("@/engine/scripts/utils/id");
