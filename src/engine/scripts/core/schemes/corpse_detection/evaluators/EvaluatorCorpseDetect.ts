...
import { IReleaseDescriptor, ReleaseBodyManager } from "@/engine/scripts/core/managers/ReleaseBodyManager";
import { ISchemeCorpseDetectionState } from "@/engine/scripts/core/schemes/corpse_detection";
