...
import type { ITradeManagerDescriptor } from "@/engine/scripts/core/managers/TradeManager";
import {
  AnomalyZoneBinder,
  LabX8DoorBinder,
  SignalLightBinder,
  SmartCover,
  SmartTerrain,
} from "@/engine/scripts/core/objects";
import type { TAbstractSchemeConstructor } from "@/engine/scripts/core/schemes/base";
import type { CampStoryManager } from "@/engine/scripts/core/schemes/camper";
import type { PatrolManager } from "@/engine/scripts/core/schemes/patrol";
import type { ReachTaskPatrolManager } from "@/engine/scripts/core/schemes/reach_task";
import type { LightManager } from "@/engine/scripts/core/schemes/sr_light";
import type { AbstractPlayableSound } from "@/engine/scripts/core/sounds/playable_sounds/AbstractPlayableSound";
