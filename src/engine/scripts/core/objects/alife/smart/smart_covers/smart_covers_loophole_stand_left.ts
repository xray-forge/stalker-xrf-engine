...
import { ISmartCoverLoopholeDescriptor } from "@/engine/scripts/core/objects/alife/smart/smart_covers/smart_covers_list";

export function get_stand_left_loophole(
  id: string,
