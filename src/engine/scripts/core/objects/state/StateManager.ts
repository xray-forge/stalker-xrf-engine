...
import * as animationManagement from "@/engine/scripts/core/objects/state/animation";
import * as animationStateManagement from "@/engine/scripts/core/objects/state/animation_state";
import { AnimationManager } from "@/engine/scripts/core/objects/state/AnimationManager";
import * as bodyStateManagement from "@/engine/scripts/core/objects/state/body_state";
import * as directionManagement from "@/engine/scripts/core/objects/state/direction";
import { EStateManagerOperator } from "@/engine/scripts/core/objects/state/EStateManagerOperator";
import { EStateManagerProperty } from "@/engine/scripts/core/objects/state/EStateManagerProperty";
...
import { animstates } from "@/engine/scripts/core/objects/state/lib/state_mgr_animstate_list";
import * as mentalManagement from "@/engine/scripts/core/objects/state/mental";
import * as movementManagement from "@/engine/scripts/core/objects/state/movement";
import * as smartCoverManagement from "@/engine/scripts/core/objects/state/smart_cover";
import * as stateManagement from "@/engine/scripts/core/objects/state/state";
import * as weaponManagement from "@/engine/scripts/core/objects/state/weapon";
