...
import { get_idle_state, get_queue_params } from "@/engine/scripts/core/objects/state/weapon/StateManagerWeapon";
import { isStalker, isWeapon } from "@/engine/scripts/utils/check/is";
