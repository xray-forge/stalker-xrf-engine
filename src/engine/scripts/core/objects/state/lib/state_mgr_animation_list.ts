      ...
      [0]: [
        ...
        { a: "guitar_a" },
        {
          f: (object: XR_game_object) => {
            ...
            const { CampStoryManager } = require("@/engine/scripts/core/schemes/camper/CampStoryManager");
        ...
        "dinamit_1",
        {
          f: (object: XR_game_object) => {
            const {
              ...
              // eslint-disable-next-line @typescript-eslint/no-var-requires
            } = require("@/engine/scripts/core/schemes/corpse_detection/SchemeCorpseDetection");
    ...
    into: {
      [0]: [
        "dinamit_1",
        {
          f: (object: XR_game_object) => {
            // eslint-disable-next-line @typescript-eslint/no-var-requires
            const { SchemeHelpWounded } = require("@/engine/scripts/core/schemes/help_wounded/SchemeHelpWounded");
