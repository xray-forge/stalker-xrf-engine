...
import { ClientGameObject, IniFile, Optional, TSection } from "@/engine/lib/types";
 ...
 */
export function setMonsterState(object: ClientGameObject, state: Optional<EMonsterState>): void {
