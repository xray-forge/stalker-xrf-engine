...
export enum EStateEvaluatorId {
  ...
  WEAPON_SET = 11,
  WEAPON_LOCKED = 12,
  WEAPON_STRAPPED_TARGET = 13,
  WEAPON_STRAPPED_NOW = 14,
  WEAPON_UNSTRAPPED_TARGET = 15,
  WEAPON_UNSTRAPPED_NOW = 16,
  WEAPON_NONE_TARGET = 17,
  WEAPON_NONE_NOW = 18,
  WEAPON_DROP_TARGET = 19,
  WEAPON_FIRE_TARGET = 20,

  // -- MOVEMENT
  MOVEMENT_SET = 21,
  MOVEMENT_WALK_TARGET = 22,
  MOVEMENT_RUN_TARGET = 23,
  MOVEMENT_STAND_TARGET = 24,
  ...
  // -- BODYSTATES
  BODYSTATE_SET = 41,
  BODYSTATE_CROUCH_TARGET = 42,
  BODYSTATE_STANDING_TARGET = 43,
