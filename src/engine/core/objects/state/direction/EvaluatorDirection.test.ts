...
import { EvaluatorDirection } from "@/engine/core/objects/state/direction/EvaluatorDirection";
...
describe("EvaluatorDirection class", () => {
  it("should correctly perform direction check when look at object and activate callback", () => {
    ...
    setStalkerState(
      ...
      null,
      { look_object: lookObject, look_position: null }
    );
    expect(evaluator.evaluate()).toBeFalsy();
  ...
  it("should correctly perform direction check by vector", () => {
    ...
    setStalkerState(
      ...
      null,
      { look_object: null, look_position: lookObject.position() }
    );
    expect(evaluator.evaluate()).toBeFalsy();
