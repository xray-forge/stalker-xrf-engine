...
import { get_smart_cover_anim_pri_a22 } from "@/engine/core/objects/server/smart/smart_covers/smart_covers_anim_pri_a22";
import { get_smart_cover_animpoint_pri_a15 } from "@/engine/core/objects/server/smart/smart_covers/smart_covers_animpoint_pri_a15";
import { get_smart_cover_animpoint_sit_high } from "@/engine/core/objects/server/smart/smart_covers/smart_covers_animpoint_sit_high";
import { get_smart_cover_animpoint_sit_low } from "@/engine/core/objects/server/smart/smart_covers/smart_covers_animpoint_sit_low";
import { get_smart_cover_animpoint_sit_normal } from "@/engine/core/objects/server/smart/smart_covers/smart_covers_animpoint_sit_normal";
import { get_smart_cover_animpoint_stay_table } from "@/engine/core/objects/server/smart/smart_covers/smart_covers_animpoint_stay_table";
import { get_smart_cover_animpoint_stay_wall } from "@/engine/core/objects/server/smart/smart_covers/smart_covers_animpoint_stay_wall";
import { get_smart_cover_combat_front } from "@/engine/core/objects/server/smart/smart_covers/smart_covers_combat_front";
import { get_smart_cover_combat_prone } from "@/engine/core/objects/server/smart/smart_covers/smart_covers_combat_prone";
