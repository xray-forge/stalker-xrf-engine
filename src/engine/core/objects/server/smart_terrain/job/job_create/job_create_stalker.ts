...
import { createStalkerAnimpointJobs } from "@/engine/core/objects/server/smart_terrain/job/job_create/job_create_stalker_animpoint";
import { createStalkerCamperJobs } from "@/engine/core/objects/server/smart_terrain/job/job_create/job_create_stalker_camper";
...
import { createStalkerGuardJobs } from "@/engine/core/objects/server/smart_terrain/job/job_create/job_create_stalker_guard";
import { createStalkerPatrolJobs } from "@/engine/core/objects/server/smart_terrain/job/job_create/job_create_stalker_patrol";
import { createStalkerPointJobs } from "@/engine/core/objects/server/smart_terrain/job/job_create/job_create_stalker_point";
import { createStalkerSleepJobs } from "@/engine/core/objects/server/smart_terrain/job/job_create/job_create_stalker_sleep";
import { createStalkerSniperJobs } from "@/engine/core/objects/server/smart_terrain/job/job_create/job_create_stalker_sniper";
import { createStalkerSurgeJobs } from "@/engine/core/objects/server/smart_terrain/job/job_create/job_create_stalker_surge";
import { createStalkerWalkerJobs } from "@/engine/core/objects/server/smart_terrain/job/job_create/job_create_stalker_walker";
import { TSmartTerrainJobsList } from "@/engine/core/objects/server/smart_terrain/job/job_types";
