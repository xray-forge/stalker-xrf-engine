...
export class ItemWeaponMagazinedWGl extends cse_alife_item_weapon_magazined_w_gl {
  ...
  public override on_register(): void {
    ...
    EventsManager.emitEvent(EGameEvent.ITEM_WEAPON_MAGAZINED_WGL_REGISTERED, this);
  }

  public override on_unregister(): void {
    EventsManager.emitEvent(EGameEvent.ITEM_WEAPON_MAGAZINED_WGL_UNREGISTERED, this);
