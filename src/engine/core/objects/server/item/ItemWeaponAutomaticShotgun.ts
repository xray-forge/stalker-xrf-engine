import { cse_alife_item_weapon_auto_shotgun, LuabindClass } from "xray16";
...
export class ItemWeaponAutomaticShotgun extends cse_alife_item_weapon_auto_shotgun {
  ...
  public override on_register(): void {
    ...
    EventsManager.emitEvent(EGameEvent.ITEM_WEAPON_AUTOMATIC_SHOTGUN_REGISTERED, this);
  }

  public override on_unregister(): void {
    EventsManager.emitEvent(EGameEvent.ITEM_WEAPON_AUTOMATIC_SHOTGUN_UNREGISTERED, this);
