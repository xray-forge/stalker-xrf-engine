...
import { MX_VECTOR, TStringId, ZERO_VECTOR } from "xray16/lib";

import { ISmartCoverLoopholeDescriptor } from "@/engine/core/animation/smart_covers/types_smart_covers";

/**
 * Create smart cover loophole descriptor for the crouching posture facing right.
 *
 ...
 * @returns Smart cover loophole descriptor for the crouching posture facing right.
 */
