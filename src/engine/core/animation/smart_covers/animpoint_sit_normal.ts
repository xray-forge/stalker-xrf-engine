...
import { getAnimpointSitNormalLoophole } from "@/engine/core/animation/smart_covers/loophole_animpoint_sit_normal";
...
/**
 * Create smart cover descriptor for the animpoint_sit_normal animation set.
 *
 * @returns Smart cover descriptor for the animpoint_sit_normal animation set.
 */
