 ...
 */
export function setupStalkerBodyStatePlanner(planner: ActionPlanner, controller: StalkerStateController): void {
  const bodyStateStateCrouch: ActionBodyStateCrouch = new ActionBodyStateCrouch(controller);
  ...
  const bodyStateCrouchDangerAction: ActionBodyStateCrouchDanger = new ActionBodyStateCrouchDanger(controller);
  ...
  const bodyStateStandingAction: ActionBodyStateStanding = new ActionBodyStateStanding(controller);
  ...
  const standingFreeAction: ActionBodyStateStandingFree = new ActionBodyStateStandingFree(controller);
