 ...
 */
export function transferItemsFromActor(to: XR_game_object, itemSection: TSection, count: TCount | "all" = 1): void {
 ...
 */
export function transferItemsToActor(from: XR_game_object, itemSection: TSection, count: TCount = 1): void {
