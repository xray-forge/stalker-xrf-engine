...
/**
 * Base scheme controller class representing an instance that works while a scheme is active.
 * Includes generic handlers and interface for implementation of scheme events.
 */
export abstract class AbstractSchemeController<T extends IBaseSchemeState> implements ISchemeEventHandler {
