...
/**
 * Controller handling physical door scheme behaviour for an object.
 */
export class PhysicalDoorController extends AbstractSchemeController<ISchemePhysicalDoorState> {
