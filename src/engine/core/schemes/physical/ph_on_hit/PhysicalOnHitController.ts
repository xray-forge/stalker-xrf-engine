...
/**
 * Controller to handle hits logic of physical game objects.
 */
export class PhysicalOnHitController extends AbstractSchemeController<ISchemePhysicalOnHitState> {
