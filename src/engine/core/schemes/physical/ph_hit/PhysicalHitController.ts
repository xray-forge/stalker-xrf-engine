...
/**
 * Controller handling physical hit scheme behaviour for an object.
 */
export class PhysicalHitController extends AbstractSchemeController<ISchemePhysicalHitState> {
