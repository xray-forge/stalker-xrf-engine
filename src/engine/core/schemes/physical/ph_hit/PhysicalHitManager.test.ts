...
describe("PhysicalHitManager", () => {
  ...
  it("should correctly hit object towards first patrol point on activation", () => {
    ...
    const manager: PhysicalHitManager = new PhysicalHitManager(object, createHitState());
  ...
  it("should correctly try switching section on update", () => {
    ...
    const manager: PhysicalHitManager = new PhysicalHitManager(object, state);
