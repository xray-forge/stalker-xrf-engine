 ...
 */
export class MeetController extends AbstractSchemeController<ISchemeMeetState> {
  ...
  public initialize(): void {
    ...
    logger.info("Initialize meet controller for: '%s', '%s', '%s'", this.object.name(), isObjectClose, isObjectFar);
