...
import { assertDefined, copyVector, Nillable, TCount, TTimestamp, vectorRotateY } from "xray16/lib";
...
export class ActionLookAround extends action_base {
   ...
   */
  public onHit(object: GameObject, amount: TCount, direction: Vector, who: Nillable<GameObject>): void {
    if (!who || !this.state.isCamperCombatAction) {
      return;
    }
