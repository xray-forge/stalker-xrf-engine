...
export class AnimpointManager extends AbstractSchemeManager<ISchemeAnimpointState> {
  ...
  public override activate(object: GameObject): void {
    logger.format("Activate animpoint scheme: %s", object.name());
  ...
  public fillPossibleAnimationActions(): void {
    ...
    logger.format("Filled available actions: %s %s", this.object.name(), this.state.approvedActions.length());
  }
   ...
   */
  public start(): void {
    logger.format("Start: %s", this.object.name());
    ...
    logger.format("Started: %s %s %s", this.object.name(), this.currentAction, this.coverName);
  }
   ...
   */
  public stop(): void {
    logger.format("Stop: %s", this.object.name());
