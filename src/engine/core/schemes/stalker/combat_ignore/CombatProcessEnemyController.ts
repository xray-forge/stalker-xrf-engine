...
/**
 * Controller deciding whether an object should accept a potential enemy when the combat ignore scheme is active.
 */
export class CombatProcessEnemyController extends AbstractSchemeController<ISchemeCombatIgnoreState> {
  /**
