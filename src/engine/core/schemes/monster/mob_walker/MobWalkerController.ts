...
/**
 * Controller handling monster walker scheme behaviour for an object.
 */
export class MobWalkerController extends AbstractSchemeController<ISchemeMobWalkerState> {
  ...
  public override activate(): void {
    ...
    if (!this.patrolWalk) {
      abort("%s - unable to find pathWalk '%s' on the map.", MobWalkerController.name, this.state.pathWalk);
    }
