...
/**
 * Controller handling monster remark scheme behaviour for an object.
 */
export class MobRemarkController extends AbstractSchemeController<ISchemeMobRemarkState> {
