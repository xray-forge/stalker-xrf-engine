 ...
 */
export class MobJumpController extends AbstractSchemeController<ISchemeMobJumpState> {
  public jumpPath: Nillable<Patrol> = null;
  public point: Nillable<Vector> = null;
  public jumpState: Nillable<EMobJumpState> = null;

  public override activate(): void {
    scriptCaptureMonster(this.object, true, MobJumpController.name);
