...
/**
 * Controller handling cutscene scheme behaviour for a restrictor zone.
 * Teleports the actor and plays a sequence of camera effectors.
 */
export class CutsceneController extends AbstractSchemeController<ISchemeCutsceneState> {
