...
/**
 * Controller handling post-process scheme behaviour for a restrictor zone.
 * Ramps a gray/noise effect and radiation/shock hits while the actor is inside.
 */
export class PostProcessController extends AbstractSchemeController<ISchemePostProcessState> {
