...
/**
 * Generation of PDA tasks section UI forms for 16/9.
 */
export function create(): JSXNode {
  return (
    <w>
      ...
      <line_devider x="34" y="90" width="753" height="3">
        <auto_frameline x="0" y="0" width="208" height="3">
          <texture>ui_inGame2_pda_map_devider</texture>
        </auto_frameline>
        <auto_static x="208" y="0" width="337" height="3" stretch="1">
          <texture>ui_inGame2_pda_map_devider_line</texture>
        </auto_static>
        <auto_frameline x="545" y="0" width="208" height="3">
          <texture>ui_inGame2_pda_map_devider</texture>
        </auto_frameline>
      </line_devider>

      <center_background x="28" y="124" width="764" height="30">
        <auto_static x="0" y="1" width="21" height="29">
          <texture>ui_inGame2_pda_missionlist_button_leftside</texture>
        </auto_static>
        <auto_frameline x="102" y="8" width="56" height="19">
          <texture>ui_inGame2_pda_missionlist_button_rightside</texture>
        </auto_frameline>
        <auto_static x="731" y="0" width="33" height="27" stretch="1">
          <texture>ui_inGame2_pda_smallbuttons_rightside</texture>
        </auto_static>
      </center_background>

      <btn_second_task x="43" y="132" width="95" height="19" hint="ui_show_second_task_wnd" frame_mode="1" stretch="1">
        ...
        <text align="c" vert_align="c" x="0" y="0" width="96" height="19" font="letterica16">
          missions_list
        </text>
        <text_color>
          <t r="255" g="255" b="255" />
      ...
      <map_wnd scroll_enable="1" map_move_step="11">
        <main_wnd x="28" y="149" width="764" height="555">
          <auto_frameline x="0" y="0" width="764" height="555" vertical="1">
            <texture>ui_inGame2_pda_map_background</texture>
          </auto_frameline>
        </main_wnd>
        <level_frame x="5" y="7" width="738" height="523" />
        <main_map_frame x="5" y="4" width="757" height="551" dx="0" dy="3" sx="15" sy="22">
          <auto_frameline x="0" y="0" width="739" height="526" vertical="1">
            <texture>ui_inGame2_pda_map_frame</texture>
          </auto_frameline>
        </main_map_frame>
        <map_hint_item x="0" y="0" width="240" height="200" stretch="1">
          <texture>ui_icons_PDA_tooltips</texture>
          <simple_text x="6" y="12" width="148" height="192" complex_mode="1">
            <text align="l" font="letterica18" />
          </simple_text>
          <t_icon x="6" y="15" width="49" height="35" />
          <t_caption x="63" y="12" width="150" height="18" complex_mode="1">
            <text align="l" font="letterica18" />
          </t_caption>
          <t_time x="63" y="38" width="150" height="18">
          ...
          <t_hint_text x="6" y="75" width="220" height="18" complex_mode="1">
            <text align="l" font="letterica18" />
          </t_hint_text>
        </map_hint_item>
      </map_wnd>

      <filter_treasures x="186" y="132" width="143" height="19" stretch="1">
      ...
      <filter_primary_objects x="329" y="132" width="143" height="19" stretch="1">
      ...
      <filter_secondary_tasks x="472" y="132" width="143" height="19" stretch="1">
      ...
      <filter_quest_npcs x="616" y="132" width="143" height="19" stretch="1">
      ...
      <storyline_task_item x="47" y="98" width="640" height="26">
        <window_name>pda_task_item1</window_name>
        <t_icon x="0" y="2" width="32" height="23" stretch="1" />
        <t_icon_over x="0" y="2" width="21" height="26" />
        <t_caption x="36" y="0" width="600" height="26">
          <text align="l" vert_align="c" font="letterica25" r="220" g="220" b="220" />
        </t_caption>
      </storyline_task_item>

      <btn_task_focus x="761" y="101" width="15" height="19" hint="ui_task_btn_focus_center" stretch="1">
        <window_name>btn_task_focus</window_name>
        <texture>ui_inGame2_pda_center_on_mission_button</texture>
      </btn_task_focus>

      <btn_nav_parent x="684" y="458" width="55" height="69">
        <btn_nav_0 x="0" y="0" width="17" height="21" hint="ui_map_btn_legend" stretch="1">
          <window_name>btn_nav_legend</window_name>
          <texture>ui_inGame2_pda_control_map_button_0</texture>
        </btn_nav_0>
        <btn_nav_1 x="19" y="0" width="17" height="21" hint="ui_map_btn_up" stretch="1">
          <window_name>btn_nav_up</window_name>
          <texture>ui_inGame2_pda_control_map_button_1</texture>
        </btn_nav_1>
        <btn_nav_2 x="38" y="0" width="17" height="21" hint="ui_map_btn_zoom_in" stretch="1">
          <window_name>btn_nav_zoom_in</window_name>
          <texture>ui_inGame2_pda_control_map_button_2</texture>
        </btn_nav_2>
        <btn_nav_3 x="0" y="24" width="17" height="21" hint="ui_map_btn_left" stretch="1">
          <window_name>btn_nav_left</window_name>
          <texture>ui_inGame2_pda_control_map_button_3</texture>
        </btn_nav_3>
        <btn_nav_4 x="19" y="24" width="17" height="21" hint="ui_map_btn_center" stretch="1">
          <window_name>btn_nav_center</window_name>
          <texture>ui_inGame2_pda_control_map_button_4</texture>
        </btn_nav_4>
        <btn_nav_5 x="38" y="24" width="17" height="21" hint="ui_map_btn_right" stretch="1">
          <window_name>btn_nav_right</window_name>
          <texture>ui_inGame2_pda_control_map_button_5</texture>
        </btn_nav_5>
        <btn_nav_6 x="0" y="48" width="17" height="21" hint="ui_map_btn_zoom_out" stretch="1">
          <window_name>btn_nav_zoom_out</window_name>
          <texture>ui_inGame2_pda_control_map_button_6</texture>
        </btn_nav_6>
        <btn_nav_7 x="19" y="48" width="17" height="21" hint="ui_map_btn_down" stretch="1">
          <window_name>btn_nav_down</window_name>
          <texture>ui_inGame2_pda_control_map_button_7</texture>
        </btn_nav_7>
        <btn_nav_8 x="38" y="48" width="17" height="21" hint="ui_map_btn_zmreset" stretch="1">
          <window_name>btn_nav_zmreset</window_name>
          <texture>ui_inGame2_pda_control_map_button_8</texture>
        </btn_nav_8>
      </btn_nav_parent>

      <second_task_wnd x="8" y="10" width="280" height="523">
        <background_frame x="0" y="0" width="275" height="513">
          <texture>ui_icons_PDA_dialog</texture>
          <auto_frameline x="12" y="33" width="253" height="3">
            <texture>ui_inGame2_pda_map_devider</texture>
          </auto_frameline>
        </background_frame>
        <t_caption x="12" y="15" width="64" height="14">
          <text align="l" font="letterica16" r="128" g="128" b="128" a="160">
            ui_pda_secondary_task
          </text>
        </t_caption>
        <t_counter x="172" y="15" width="40" height="14">
          <text align="r" font="letterica16" color="ui_4" />
        </t_counter>
        <btn_close x="251" y="10" width="12" height="15" stretch="1">
        ...
        />
        <task_item x="0" y="0" width="238" height="35">
          <activ r="255" g="255" b="255" />
          <unread r="220" g="220" b="220" />
          <read r="100" g="100" b="100" />
          <st_story x="0" y="1" width="15" height="19" stretch="1" />

          <name x="22" y="0" width="197" height="30">
            <text align="l" font="letterica18" complex_mode="1" />
          </name>
          <btn_focus x="220" y="1" width="15" height="19" hint="ui_task_btn_focus_center2" stretch="1">
      ...
      <map_legend_wnd x="560" y="10" width="184" height="390">
        <background_frame x="0" y="0" width="184" height="390">
          <texture>ui_icons_PDA_dialog</texture>
          <auto_frameline x="11" y="33" width="161" height="4">
        ...
        <btn_close x="160" y="10" width="12" height="15" stretch="1">
          <window_name>task_btn_close</window_name>
          <texture>ui_task_bt_close</texture>
        </btn_close>
        <legend_list
        ...
        >
          <item x="0" y="0" width="220" height="26">
            <image x="8" y="0" width="15" height="19" stretch="1">
              <texture>ui_inGame2_PDA_icon_Primary_mission</texture>
            </image>
            <text_static x="32" y="2" width="184" height="16" complex_mode="1">
              <text align="l" font="letterica16" r="170" g="170" b="170">
          ...
          <item x="0" y="0" width="220" height="26">
            <image x="8" y="0" width="16" height="20" stretch="1">
          ...
          <item x="0" y="0" width="220" height="26">
            <image x="11" y="3" width="9" height="11" stretch="1">
          ...
          <item x="0" y="0" width="220" height="26">
            <image x="10" y="2" width="10" height="12" stretch="1">
