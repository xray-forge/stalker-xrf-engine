...
export function create(): JSXNode {
  return (
    <w>
      ...
      <progress_enemy_state x="525" y="300" width="220" height="57" min="0" max="100" pos="0" mode="back">
        <progress>
          <texture color="pda_green">ui_pda2_big_progress</texture>
        </progress>
        <background>
      ...
      <progress_our_mem_count x="62" y="470" width="433" height="38" min="0" max="100" pos="0" mode="horz">
        <progress>
      ...
      <progress_enemy_mem_count x="530" y="470" width="433" height="38" min="0" max="100" pos="0" mode="back">
        <progress>
          <texture color="pda_yellow">ui_pda2_small_progress</texture>
        </progress>
        <background>
      ...
      <progress_our_resource x="62" y="550" width="433" height="38" min="0" max="100" pos="0" mode="horz">
        <progress>
          <texture color="pda_yellow">ui_pda2_small_progress</texture>
        </progress>
        <background>
      ...
      <progress_enemy_resource x="530" y="550" width="433" height="38" min="0" max="100" pos="0" mode="back">
        <progress>
          <texture color="pda_yellow">ui_pda2_small_progress</texture>
        </progress>
        <background>
