...
import { OptionsControls } from "@/engine/forms/menu/options/OptionsControls.part";
import { OptionsGameplay } from "@/engine/forms/menu/options/OptionsGameplay.part";
import { OptionsSounds } from "@/engine/forms/menu/options/OptionsSounds.part";
