...
/**
 * Create the PDA map screen UI with caption, clock, tabs and close button.
 *
 * @returns Rendered PDA map screen component.
 */
export function Pda(): JSXNode {
  return (
    <w>
      <main x={"0"} y={"0"} width={"1024"} height={"768"} />
      <background_static x={"0"} y={"0"} width={"1024"} height={"768"}>
      ...
      <close_button x={"973"} y={"26"} width={"33"} height={"34"} hint={"pda_btn_close"}>
      ...
      <tab x={"443"} y={"57"} width={"468"} height={"27"}>
        <button
          x={"0"}
          y={"0"}
          width={"172"}
