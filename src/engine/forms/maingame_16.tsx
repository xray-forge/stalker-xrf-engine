...
export function create(): JSXNode {
  return (
    <w>
      <main x="0" y="0" width="1024" height="768"></main>
      ...
      <indicator_booster_psy x="16" y="660" width="24" height="41" stretch="1">
        <texture>ui_inGame2_shield_Psy</texture>
      </indicator_booster_psy>
      <indicator_booster_radia x="49" y="660" width="24" height="41" stretch="1">
        <texture>ui_inGame2_shield_Radiation</texture>
      </indicator_booster_radia>
      <indicator_booster_chem x="83" y="660" width="24" height="41" stretch="1">
        <texture>ui_inGame2_shield_biological</texture>
      </indicator_booster_chem>
      <indicator_booster_wound x="116" y="660" width="24" height="41" stretch="1">
        <texture>ui_inGame2_shield_blood</texture>
      </indicator_booster_wound>
      <indicator_booster_weight x="150" y="660" width="24" height="41" stretch="1">
        <texture>ui_inGame2_shield_force</texture>
      </indicator_booster_weight>
      <indicator_booster_health x="184" y="660" width="24" height="41" stretch="1">
        <texture>ui_inGame2_shield_health</texture>
      </indicator_booster_health>
      <indicator_booster_power x="217" y="660" width="24" height="41" stretch="1">
        <texture>ui_inGame2_shield_stamina</texture>
      </indicator_booster_power>
      <indicator_booster_rad x="251" y="660" width="24" height="41" stretch="1">
      ...
      <disk_io x="760" y="750" width="14" height="16" stretch="1"></disk_io>
      ...
      <hud_states x="0" y="0" width="1024" height="768" stretch="1">
        ...
        <static_cur_ammo x="887" y="690" width="54" height="37">
          <text complex_mode="0" font="graffiti32" color="ui_7" align="c" vert_align="c">
            ammo
          </text>
        </static_cur_ammo>

        <static_fmj_ammo x="887" y="724" width="26" height="15">
          <text align="c" complex_mode="0" font="graffiti19" color="ui_7">
            fmj
          </text>
        </static_fmj_ammo>

        <static_ap_ammo x="915" y="724" width="26" height="15">
          <text align="c" complex_mode="0" font="graffiti19" r="238" g="155" b="23" a="150">
            ap
          </text>
        </static_ap_ammo>

        <static_grenade x="864" y="690" width="14" height="19">
          <text align="c" complex_mode="0" font="letterica16" color="ui_7" vert_align="c">
            gr
          </text>
        </static_grenade>
