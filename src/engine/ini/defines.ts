...
export const config = {
  ...
  weapon_probability: {
    hit_probability_gd_novice: 0.2,
    hit_probability_gd_stalker: 0.3,
    hit_probability_gd_veteran: 0.4,
    hit_probability_gd_master: 0.5,
  },
  ...
  common_ph_friction_params_on_npc_death: {
    ph_skeleton_airr_lin_factor: 2.0, // ;550.0
    ph_skeleton_airr_ang_factor: 0.0, // ;0.0
    ph_skeleton_hinger_factor1: 1.0, // ;1.0
