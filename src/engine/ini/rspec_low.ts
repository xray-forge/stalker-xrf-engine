...
export const config = {
  [LTX_ROOT]: {
    ...
    r2_ls_squality: newFloatField(0.75, { isBinding: true }),
    ...
    r__detail_density: newFloatField(0.5, { isBinding: true }),
    ...
    r__wallmark_ttl: newIntegerField(30, { isBinding: true }),
    rs_skeleton_update: newIntegerField(32, { isBinding: true }),
    rs_vis_distance: newFloatField(0.75, { isBinding: true }),
    snd_cache_size: newIntegerField(24, { isBinding: true }),
    snd_targets: newIntegerField(24, { isBinding: true }),
    texture_lod: newIntegerField(2, { isBinding: true }),
  },
};
