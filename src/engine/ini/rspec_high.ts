...
export const config = {
  [LTX_ROOT]: {
    ...
    r1_dlights_clip: newIntegerField(40, { isBinding: true }),
    ...
    r2_ssao: newStringField(captions.st_opt_medium, { isBinding: true }),
    r2_steep_parallax: newStringField(ON, { isBinding: true }),
    r2_sun_quality: newStringField(captions.st_opt_medium, { isBinding: true }),
    r2_sun_shafts: newStringField(captions.st_opt_medium, { isBinding: true }),
    ...
    r__detail_density: newFloatField(0.3, { isBinding: true }),
    r__geometry_lod: newFloatField(0.75, { isBinding: true }),
    r__supersample: newIntegerField(1, { isBinding: true }),
    r__tf_aniso: newIntegerField(8, { isBinding: true }),
    r__wallmark_ttl: newIntegerField(50, { isBinding: true }),
