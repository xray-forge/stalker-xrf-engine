...
export * from "@/fixtures/xray/mocks/interface/mainMenuInterface.mock";
export * from "@/fixtures/xray/mocks/interface/relationRegistryInterface.mock";

export { mockActorStatsInterface } from "xray16/mocks";
