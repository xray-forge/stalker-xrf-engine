 ...
 * todo;
 */
export function mockServerAlifeItemWeapon(base: Partial<cse_alife_item_weapon> = {}): cse_alife_item_weapon {
  return { ...mockServerAlifeItem(base) } as unknown as cse_alife_item_weapon;
}
