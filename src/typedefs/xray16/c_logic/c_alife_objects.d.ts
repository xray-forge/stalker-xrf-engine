...
declare global {
   ...
   * C++ class cse_motion {
   */
  interface IXR_cse_motion {
  }

  /**
   * C++ class cse_alife_group_abstract {
   */
  interface IXR_cse_alife_group_abstract {
  }

  /**
   * C++ class cse_ph_skeleton {
   */
  interface IXR_cse_ph_skeleton {
  }

  /**
   *  C++ class cse_visual {
   */
  interface IXR_cse_visual {
  }

  /**
   * C++ class cse_shape {
   */
  interface IXR_cse_shape {
  }

  /**
   *  C++ class cse_alife_schedulable : ipure_schedulable_object {
   */
  interface IXR_cse_alife_schedulable extends IXR_ipure_schedulable_object {
  }

  /**
   *  C++ class ipure_alife_load_object {
   */
  interface IXR_ipure_alife_load_object {
  }

  /**
   *  C++ class ipure_alife_save_object {
   */
  interface IXR_ipure_alife_save_object {
  }

  /**
   *  C++ class ipure_alife_load_save_object : ipure_alife_load_object,ipure_alife_save_object {
   */
  interface IXR_ipure_alife_load_save_object extends IXR_ipure_alife_load_object, IXR_ipure_alife_save_object {
  }

  /**
   *  C++ class ipure_server_object : ipure_alife_load_save_object {
   */
  interface IXR_ipure_server_object extends IXR_ipure_alife_load_save_object {
  }

  /**
   *  C++ class cpure_server_object : ipure_server_object {
   */
  interface IXR_cpure_server_object extends IXR_ipure_server_object {
  }

  /**
   *  C++ class cse_abstract : cpure_server_object {
   */
  interface IXR_cse_abstract extends IXR_cpure_server_object{
    angle: number;
    id: number;
    parent_id: number;
    position: unknown;
   ...
   */
  interface IXR_cse_alife_object_breakable extends IXR_cse_alife_dynamic_object_visual {
  }

  /**
   * C++ class cse_alife_trader_abstract {
   */
  interface IXR_cse_alife_trader_abstract {
     reputation(): number;
     rank(): number;
     community(): unknown;
  }
   ...
   */
  interface IXR_cse_alife_object extends IXR_cse_abstract {
   ...
   */
  interface IXR_cse_alife_dynamic_object extends IXR_cse_alife_object {
   ...
   */
  interface IXR_cse_alife_space_restrictor extends IXR_cse_alife_dynamic_object, IXR_cse_shape {
  }

  /**
   * C++ class cse_alife_dynamic_object_visual : cse_alife_dynamic_object,cse_visual {
   */
  interface IXR_cse_alife_dynamic_object_visual extends IXR_cse_alife_dynamic_object, IXR_cse_visual {
  }

  /**
   * C++ class cse_custom_zone : cse_alife_dynamic_object,cse_shape {
   */
  interface IXR_cse_custom_zone extends IXR_cse_alife_dynamic_object, IXR_cse_shape {
  }

  /**
   * C++ class cse_alife_creature_abstract : cse_alife_dynamic_object_visual {
   */
  interface IXR_cse_alife_creature_abstract extends IXR_cse_alife_dynamic_object_visual {
    group: number;
    squad: number;
    team: number;
    health(): unknown;
   ...
   * */
  interface IXR_cse_alife_human_abstract extends IXR_cse_alife_monster_abstract {
   ...
   */
  interface IXR_cse_alife_inventory_item {
  }

  /**
   * C++ class cse_alife_item : cse_alife_dynamic_object_visual,cse_alife_inventory_item {
   */
  interface IXR_cse_alife_item extends IXR_cse_alife_dynamic_object_visual, IXR_cse_alife_inventory_item {
    bfUseful(): unknown;
  }
   ...
   */
  interface IXR_cse_alife_item_weapon extends IXR_cse_alife_item {
   ...
   */
  interface IXR_cse_alife_item_weapon_magazined extends IXR_cse_alife_item_weapon {
  }

  /**
   * C++ class cse_alife_item_weapon_magazined_w_gl : cse_alife_item_weapon_magazined {
   */
  interface IXR_cse_alife_item_weapon_magazined_w_gl extends IXR_cse_alife_item_weapon {
  }

  /**
   * C++ class cse_alife_item_weapon_shotgun : cse_alife_item_weapon {
   */
  interface IXR_cse_alife_item_weapon_shotgun extends IXR_cse_alife_item_weapon {
  }

  /**
   * C++ class cse_alife_level_changer : cse_alife_space_restrictor {
   */
  interface IXR_cse_alife_level_changer extends IXR_cse_alife_space_restrictor {
  }

  /**
   * C++ class cse_alife_monster_abstract : cse_alife_creature_abstract,cse_alife_schedulable {
   */
  interface IXR_cse_alife_monster_abstract extends IXR_cse_alife_creature_abstract, IXR_cse_alife_schedulable {
   ...
   */
  interface IXR_cse_alife_monster_base extends IXR_cse_alife_monster_abstract, IXR_cse_ph_skeleton {
  }

  /**
   *  C++ class cse_alife_monster_rat : cse_alife_monster_abstract,cse_alife_inventory_item {
   */
  interface IXR_cse_alife_monster_rat extends IXR_cse_alife_monster_abstract, IXR_cse_alife_inventory_item {
  }

  /**
   * C++ class cse_alife_monster_zombie : cse_alife_monster_abstract {}
   */
  interface IXR_cse_alife_monster_zombie extends IXR_cse_alife_monster_abstract {
  }

  /**
   * C++ class cse_alife_mounted_weapon : cse_alife_dynamic_object_visual {
   */
  interface IXR_cse_alife_mounted_weapon extends IXR_cse_alife_dynamic_object_visual {
  }

  /**
   * C++ class cse_alife_inventory_box : cse_alife_dynamic_object_visual {
   */
  interface IXR_cse_alife_inventory_box extends IXR_cse_alife_dynamic_object_visual {
  }

  /**
   * C++ class cse_alife_item_ammo : cse_alife_item {
   */
  interface IXR_cse_alife_item_ammo extends IXR_cse_alife_item {
  }

  /**
   * C++ class cse_alife_item_artefact : cse_alife_item {
   */
  interface IXR_cse_alife_item_artefact extends IXR_cse_alife_item {
  }

  /**
   * C++ class cse_alife_item_bolt : cse_alife_item {
   */
  interface IXR_cse_alife_item_bolt extends IXR_cse_alife_item {
  }

  /**
   * C++ class cse_alife_item_custom_outfit : cse_alife_item {
   */
  interface IXR_cse_alife_item_custom_outfit extends IXR_cse_alife_item {
  }
   ...
   */
  interface IXR_cse_alife_item_document extends IXR_cse_alife_item {
  }

  /**
   * C++ class cse_alife_item_explosive : cse_alife_item {
   */
  interface IXR_cse_alife_item_explosive extends IXR_cse_alife_item {
  }

  /**
   * C++ class cse_alife_item_grenade : cse_alife_item {
   */
  interface IXR_cse_alife_item_grenade extends IXR_cse_alife_item {
  }

  /**
   * C++ class cse_alife_item_pda : cse_alife_item {
   */
  interface IXR_cse_alife_item_pda extends IXR_cse_alife_item {
  }

  /**
   * C++ class cse_alife_item_torch : cse_alife_item
   */
  interface IXR_cse_alife_item_torch extends IXR_cse_alife_item {
  }

  /**
   * C++ class cse_alife_item_weapon_auto_shotgun : cse_alife_item_weapon {
   */
  interface IXR_cse_alife_item_weapon_auto_shotgun extends IXR_cse_alife_item_weapon {
  }

  /**
   * C++ class cse_anomalous_zone : cse_custom_zone {
   */
  interface IXR_cse_anomalous_zone extends IXR_cse_custom_zone {
  }

  /**
   * C++ class cse_alife_object_climable : cse_shape,cse_abstract {
   **/
  interface IXR_cse_alife_object_climable extends IXR_cse_shape, IXR_cse_abstract {
    init(): void;
  }
   ...
   **/
  interface IXR_cse_alife_object_hanging_lamp extends IXR_cse_alife_dynamic_object_visual, IXR_cse_ph_skeleton {
  }

  /**
   * C++ class cse_alife_object_physic : cse_alife_dynamic_object_visual,cse_ph_skeleton {
   **/
  interface IXR_cse_alife_object_physic extends IXR_cse_alife_dynamic_object_visual, IXR_cse_ph_skeleton {
  }

  /**
   * C++ class cse_alife_object_projector : cse_alife_dynamic_object_visual {
   **/
  interface IXR_cse_alife_object_projector extends IXR_cse_alife_dynamic_object_visual {
  }

  /**
   * C++ class cse_alife_online_offline_group : cse_alife_dynamic_object,cse_alife_schedulable {
   **/
  interface IXR_cse_alife_online_offline_group extends IXR_cse_alife_dynamic_object, IXR_cse_alife_schedulable {
     update(): unknown;
   ...
   */
  interface IXR_cse_alife_ph_skeleton_object extends IXR_cse_alife_dynamic_object_visual, IXR_cse_ph_skeleton {
  }

  /**
   * C++ class cse_alife_psydog_phantom : cse_alife_monster_base {
   */
  interface IXR_cse_alife_psydog_phantom extends IXR_cse_alife_monster_abstract {
  }

  /**
   * C++ class cse_alife_smart_zone : cse_alife_space_restrictor,cse_alife_schedulable {
   */
  interface IXR_cse_alife_smart_zone extends IXR_cse_alife_space_restrictor, IXR_cse_alife_schedulable {
   ...
   */
  interface IXR_cse_alife_team_base_zone extends IXR_cse_alife_space_restrictor {
  }

  /**
   * C++ class cse_torrid_zone : cse_custom_zone,cse_motion {
   */
  interface IXR_cse_torrid_zone extends IXR_cse_custom_zone, IXR_cse_abstract {
  }

  /**
   * C++ class cse_alife_trader : cse_alife_dynamic_object_visual,cse_alife_trader_abstract {
   */
  interface IXR_cse_alife_trader extends IXR_cse_alife_dynamic_object_visual, IXR_cse_alife_trader_abstract {
   ...
   */
  interface IXR_cse_smart_cover extends IXR_cse_alife_dynamic_object {
     description(): string;
   ...
   */
  interface IXR_cse_alife_car extends IXR_cse_alife_dynamic_object_visual, IXR_cse_ph_skeleton {
  }

  /**
   * C++ class cse_alife_creature_actor : cse_alife_creature_abstract,cse_alife_trader_abstract,cse_ph_skeleton {
   */
  interface IXR_cse_alife_creature_actor extends
   ...
   */
  interface IXR_cse_alife_creature_crow extends IXR_cse_alife_creature_abstract {
  }

  /**
   * C++ class cse_alife_creature_phantom : cse_alife_creature_abstract {
   */
  interface IXR_cse_alife_creature_phantom extends IXR_cse_alife_creature_abstract {
  }

  /**
   * C++ class cse_alife_graph_point : cse_abstract {
   */
  interface IXR_cse_alife_graph_point extends IXR_cse_abstract {
    init(): void;
  }
   ...
   */
  interface IXR_cse_alife_helicopter extends IXR_cse_alife_dynamic_object_visual, IXR_cse_motion, IXR_cse_ph_skeleton {
  }

  /**
   * C++ class cse_alife_human_stalker : cse_alife_human_abstract,cse_ph_skeleton {
   */
  interface IXR_cse_alife_human_stalker extends IXR_cse_alife_human_abstract, IXR_cse_ph_skeleton {
  }
}
