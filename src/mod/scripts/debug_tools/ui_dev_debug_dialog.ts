...
export const UiDevDebugDialog: IUiDevDebugDialog = declare_xr_class(
  ...
  CUIScriptWnd,
  {
     ...
     *   this.cap_rubel_coeff.TextControl().SetText    (game.translate_string("x") .. " " .. tostring(RU_coeff) .. " RU")
     *
     ...
     *
     *   btn                = xml.Init3tButton("form:btn_moneyplus",    this.form)
     *   this.Register            (btn, "button_moneyplus")
     *   btn                = xml.Init3tButton("form:btn_moneyminus",    this.form)
     *   this.Register            (btn, "button_moneyminus")
     *
     *
