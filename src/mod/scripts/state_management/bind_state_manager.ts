...
import { StateManagerEvaIdleItems } from "@/mod/scripts/state_management/state/StateManagerEvaIdleItems";
import { StateManagerEvaLogicActive } from "@/mod/scripts/state_management/state/StateManagerEvaLogicActive";
 ...
 *
 *    manager:add_evaluator(properties["state_mgr_idle_combat"],
 *    evaluator_state_mgr_idle("state_mgr_idle_combat", state_manager))
 *    manager:add_evaluator(properties["state_mgr_idle_alife"],
 *    evaluator_state_mgr_idle_alife("state_mgr_idle_alife", state_manager))
 *    manager:add_evaluator(properties["state_mgr_idle_items"],
 *    evaluator_state_mgr_idle_items("state_mgr_idle_items", state_manager))
 *    manager:add_evaluator(properties["state_mgr_logic_active"],
