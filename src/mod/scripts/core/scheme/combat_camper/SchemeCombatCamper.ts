...
import { ActionLookAround, ActionShoot } from "@/mod/scripts/core/scheme/combat_camper/actions";
import { EvaluatorCombatCamper, EvaluatorSee } from "@/mod/scripts/core/scheme/combat_camper/evaluator";
