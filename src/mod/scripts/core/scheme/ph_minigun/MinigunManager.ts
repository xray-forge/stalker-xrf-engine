...
import { Optional, TName, TStringId } from "@/mod/lib/types";
...
import { mobCaptured } from "@/mod/scripts/core/scheme/mobCaptured";
import { mobRelease } from "@/mod/scripts/core/scheme/mobRelease";
import { ISchemeMinigunState } from "@/mod/scripts/core/scheme/ph_minigun/ISchemeMinigunState";
import { switchToSection } from "@/mod/scripts/core/scheme/switchToSection";
import { getStoryObject } from "@/mod/scripts/utils/alife";
import { isHeavilyWounded } from "@/mod/scripts/utils/check/check";
  ...
  public override resetScheme(): void {
    ...
    if (this.hasWeapon) {
      ...
      if (this.state.on_target_vis) {
        ...
        if (vis.v1 !== null) {
          const storyObject = getStoryObject(vis.v1 as TStringId);
      ...
      if (this.state.on_target_nvis) {
        ...
        if (nvis.v1 !== null) {
          const storyObject = getStoryObject(nvis.v1 as TStringId);
