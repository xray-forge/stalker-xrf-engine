...
import { add_animpoint_animation_list } from "@/mod/scripts/core/object/state/lib/state_mgr_animation_list_animpoint";
import { add_animation_list_pri_a15 } from "@/mod/scripts/core/object/state/lib/state_mgr_pri_a15";
import { add_animation_list_scenario } from "@/mod/scripts/core/object/state/lib/state_mgr_scenario";
      ...
      [0]: [
        ...
        { a: "guitar_a" },
        {
          f: (object: XR_game_object) => {
            ...
            const { CampStoryManager } = require("@/mod/scripts/core/scheme/camper/CampStoryManager");
        ...
        "dinamit_1",
        {
          f: (object: XR_game_object) => {
            const {
              ...
              // eslint-disable-next-line @typescript-eslint/no-var-requires
            } = require("@/mod/scripts/core/scheme/corpse_detection/SchemeCorpseDetection");
    ...
    into: {
      [0]: [
        "dinamit_1",
        {
          f: (object: XR_game_object) => {
            // eslint-disable-next-line @typescript-eslint/no-var-requires
            const { SchemeHelpWounded } = require("@/mod/scripts/core/scheme/help_wounded/SchemeHelpWounded");
