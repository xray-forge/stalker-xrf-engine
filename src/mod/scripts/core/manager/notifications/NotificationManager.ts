...
} from "@/mod/scripts/core/manager/notifications/NotificationManagerIcons";
import {
  notificationTaskDescription,
  TNotificationTaskDescription,
  TNotificationTaskDescriptionKey,
} from "@/mod/scripts/core/manager/notifications/NotificationTaskDescription";
import { isHeavilyWounded } from "@/mod/scripts/utils/check/check";
import { isStalkerClassId } from "@/mod/scripts/utils/check/is";
