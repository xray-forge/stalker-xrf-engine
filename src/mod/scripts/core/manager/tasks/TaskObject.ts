...
import * as TaskFunctor from "@/mod/scripts/core/manager/tasks/TaskFunctor";
import {
  getConfigBoolean,
  getConfigNumber,
  getConfigString,
...
import { giveMoneyToActor, relocateQuestItemSection, takeMoneyFromActor } from "@/mod/scripts/utils/quest";
