...
import { ActionGoPosition } from "@/mod/scripts/core/schemes/kamp/actions/ActionGoPosition";
import { ActionWait, IActionWait } from "@/mod/scripts/core/schemes/kamp/actions/ActionWait";
import { EvaluatorCampEnd, EvaluatorOnPosition } from "@/mod/scripts/core/schemes/kamp/evaluators";
...
const logger: LuaLogger = new LuaLogger("SchemeCamp");

// todo: Rename to camp patrol?
export class SchemeCamp extends AbstractScheme {
