...
import { get_idle_state, get_queue_params } from "@/mod/scripts/core/objects/state/weapon/StateManagerWeapon";
import { isStalker, isWeapon } from "@/mod/scripts/utils/check/is";
