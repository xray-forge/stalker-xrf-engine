...
import { AnimationManager } from "@/mod/scripts/core/objects/state/AnimationManager";
import * as bodyStateManagement from "@/mod/scripts/core/objects/state/body_state";
import * as directionManagement from "@/mod/scripts/core/objects/state/direction";
import { EStateManagerOperator } from "@/mod/scripts/core/objects/state/EStateManagerOperator";
...
import { animations } from "@/mod/scripts/core/objects/state/lib/state_mgr_animation_list";
import { animstates } from "@/mod/scripts/core/objects/state/lib/state_mgr_animstate_list";
import * as mentalManagement from "@/mod/scripts/core/objects/state/mental";
import * as movementManagement from "@/mod/scripts/core/objects/state/movement";
import * as smartCoverManagement from "@/mod/scripts/core/objects/state/smart_cover";
import * as stateManagement from "@/mod/scripts/core/objects/state/state";
import * as weaponManagement from "@/mod/scripts/core/objects/state/weapon";
import { get_weapon } from "@/mod/scripts/core/objects/state/weapon/StateManagerWeapon";
