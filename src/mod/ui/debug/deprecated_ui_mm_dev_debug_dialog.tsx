      ...
      <w>
        ...
        <form x={50} y={252} width={560} height={460} stretch={1}>
          ...
          <btn_moneyplus x={190} y={90} width={30} height={20}>
            <text align={"c"} font={fonts.letterica16} r={227} g={199} b={178}>
              +
            </text>
            <texture>{textures.ui_inGame2_Mp_bigbuttone}</texture>
          </btn_moneyplus>
          ...
          <btn_surge x={375} y={120} width={135} height={26}>
            <texture>{textures.ui_inGame2_Mp_bigbuttone}</texture>
            <text font={fonts.letterica18}>Enable Blowout</text>
          </btn_surge>
        ...
        <dialog x={50} y={50} width={610} height={270}>
          ...
          <btn_3 x={25} y={98} width={117} height={29}>
            ...
            <texture_t>ui_button_ordinary_t</texture_t>
            <texture_h>ui_button_ordinary_h</texture_h>
            <text font={fonts.letterica18}>Get Curren Position</text>
          </btn_3>
          ...
          <btn_4 x={180} y={165} width={157} height={48}>
            ...
            <text_color>
              <e r={227} g={199} b={178} /> <t r={180} g={153} b={155} /> <d r={106} g={95} b={91} />{" "}
              <h r={0} g={0} b={0} />
            </text_color>
          </btn_4>
          ...
          <btn_5 x={360} y={160} width={137} height={29}>
            ...
            <texture_t>ui_button_ordinary_t</texture_t>
            <texture_h>ui_button_ordinary_h</texture_h>
            <text font={fonts.letterica18}>Jump 5M Forward</text>
          </btn_5>
        </dialog>
      </w>
        ...
        <item>
          ...
          <main_wnd>
            <auto_static
              ...
              la_alpha={1}
            >
              <text align={"c"} font={fonts.graffiti22} color={"tut_gray"}>
